...
 ![Скриншот: Изменения в окне окончания инсталляции Silverlight](Screenshot__Changes_in_window_of_end_of_installation_Silverlight.png "Скриншот: Изменения в окне окончания инсталляции Silverlight")
...
![Рисунок: Внутреннее устройство приложения Silverlight](Drawing__Application_Internals_Silverlight.png "Рисунок: Внутреннее устройство приложения Silverlight")
...
![Скриншот: Hello World Silverlight в IE 7](Screenshot__Hello_World_Silverlight_в_IE_7.png "Скриншот: Hello World Silverlight в IE 7")
...
![Скриншот: Hello World Silverlight в Google Chrome](Screenshot__Hello_World_Silverlight_в_Google_Chrome.png "Скриншот: Hello World Silverlight в Google Chrome")
...
![Скриншот: Удаление Silverlight из системы](Screenshot__Remove_Silverlight_from_system.png "Скриншот: Удаление Silverlight из системы")
